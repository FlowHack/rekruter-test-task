...
1. **Локальная БД вместо CRM** — вместо Bitrix24 данные пишутся в SQLite.
2. **Минимум файлов** — вся логика в 2 модулях, без излишней абстракции.
3. **Только текстовый ввод** — без кнопок для выбора города/услуги, только последовательный опрос.
